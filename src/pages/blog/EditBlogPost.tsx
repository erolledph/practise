...
export function EditBlogPost() {
  ...
  if (!postId) {
    return (
      <div className="max-w-2xl mx-auto space-y-6 fade-in">
        <div className="text-center py-12">
          <h1 className="text-2xl font-bold text-destructive mb-2">Post ID Missing</h1>
          <p className="text-muted-foreground">No post ID provided for editing.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="max-w-4xl mx-auto space-y-6 fade-in">
      <div className="dashboard-header">
        ...
        <p className="dashboard-subtitle">
          Edit blog post for "{blogSite.name}"
        </p>
      </div>
      ...
      <Card className="card-hover shadow-lg">
        ...
        <CardContent>
          <EditBlogPostForm siteId={siteId!} postId={postId} siteName={blogSite.name} />
        </CardContent>
      </Card>
    </div>
  )
